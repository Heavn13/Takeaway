...
import com.example.heavn.fanfan.Customer.CustomerTakeOrderActivity;
...
public class BackstageRiderVerifyActivity extends BaseActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.accept:
                verify(true);
                sendMessage("恭喜你，你的账号已经被审核通过。接下来，你可以进行外卖的接单与配送等操作，赶紧开始赚取你的第一桶金吧！",true);
                break;
            case R.id.reject:
                ...
                AlertDialog dialog = new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                hideSoftKeyboard(BackstageRiderVerifyActivity.this);
...
//                    Log.e("json",res);
    ...
    private void sendMessage(String content, final Boolean verify){
        ...
        RequestBody requestBody = new FormBody.Builder().add("date",""+date).add("type","rider")
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if(verify){
                                ...
                                Toast.makeText(BackstageRiderVerifyActivity.this, "已将审核不通过的理由发送至该骑手", Toast.LENGTH_SHORT).show();
                            }
